...
from plotting.structs import LONG_TRACKS_DICT, ALL_METHODS_DICT, SHORT_TRACKS_DICT, COLORS, FONTSIZE
...
def main(args):
    ...
    print("***[DEBUG]*** in main() train_tracks: ", train_tracks, type(train_tracks))
    ...
    for aggregator, fn in zip(['mean_minmax'], [MeanMinMax()]):
        ...
        print("***[DEBUG]*** in main() axes, type(axes): ", axes, type(axes))
        print("***[DEBUG]*** in main() train_tracks: ", train_tracks, type(train_tracks))
