...
LONG_TRACKS_DICT = {'austria': 'AUSTRIA', 'columbia': 'COLUMBIA',
                    'treitlstrasse': 'TREITLSTRASSE', 'treitlstrasse-v2': 'TREITLSTRASSE', 'treitlstrassev2': 'TREITLSTRASSE',
                    'barcelona': 'BARCELONA', 'circle-cw': 'CIRCLE-CW', 'gbr': 'GBR', 'plechaty': 'PLECHATY', 'torino': 'TORINO'}
SHORT_TRACKS_DICT = {'austria': 'AUT', 'columbia': 'COL',
                     'treitlstrasse': 'TRT', 'treitlstrasse_v2': 'TRT', 'treitlstrassev2': 'TRT',
                     'barcelona': 'BRC', 'circle-cw': 'CCW'}
