...
```
python dream.py --track columbia --obs_type lidar
```

Train the agent with Occupancy Map reconstruction:
```
python dream.py --track circle_cw --obs_type lidar_occupancy
```
...
python evaluations/run_evaluation.py --agent dreamer \
                                     --trained_on circle-cw \
                                     --obs_type lidar \
                                     --checkpoint_dir logs/experiments \
...
python plotting/plot_training_curves.py --indir logs/experiments \
                                        ...
                                        --methods dreamer mpo \
                                        --tracks austria columbia treitlstrasse-v2 \
                                        --legend
```
...
python plotting/plot_test_evaluation.py --indir logs/evaluations \
                                        ...
                                        --methods dreamer mpo \
                                        --vis_tracks austria columbia treitlstrasse-v2 \
                                        --legend
```
